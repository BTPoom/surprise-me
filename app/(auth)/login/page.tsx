    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <Card className="w-full max-w-md border-rose-100 shadow-xl">
        <CardHeader className="text-center">
          ...
          <CardDescription>ยินดีต้อนรับกลับมา! กรุณาเข้าสู่ระบบเพื่อสร้างหน้าเซอร์ไพรส์</CardDescription>
        </CardHeader>
        <CardContent className="space-y-4">
          ...
          <div className="text-center text-sm">
            <Link href="/forgot-password" className="text-rose-500 hover:underline">ลืมรหัสผ่าน?</Link>
          </div>
          ...
          <p className="text-center text-sm text-slate-500">ยังไม่มีบัญชี? <Link href="/register" className="text-rose-500 hover:underline">สมัครสมาชิก</Link></p>
        </CardContent>
      </Card>
    </div>
  );
