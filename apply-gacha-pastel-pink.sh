#!/usr/bin/env bash
# apply-gacha-pastel-pink.sh
# รันจาก root ของโปรเจกต์ (โฟลเดอร์ที่มี package.json)
#   chmod +x apply-gacha-pastel-pink.sh && ./apply-gacha-pastel-pink.sh
#
# เปลี่ยนโทนสีตู้กาชาให้เป็นชมพู-ครีมพาสเทลล้วน (ตามภาพอ้างอิง "Lova Page")
# - เอาเส้นขอบดำหนาออก เปลี่ยนเป็นเส้นขอบชมพูอ่อนบางลง
# - พื้นหลัง/ตัวตู้เป็นครีม-ชมพูอ่อน แทนที่จะเป็น wine/gold เข้ม
# - คงฟังก์ชัน Back และ Copy link ที่แก้ไว้ก่อนหน้านี้
set -e
echo "กำลังเขียนไฟล์..."
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="relative text-xs font-bold text-rose-400 tracking-wide mb-3">
