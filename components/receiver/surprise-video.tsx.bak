...
import { Play, Pause, Volume2, VolumeX, Maximize, X, Film, Tv, Clapperboard } from "lucide-react";
        ...
        <div className="bg-amber-900 rounded-[2rem] p-5 shadow-xl border-4 border-amber-950 relative">
          ...
          <AnimatePresence>
            {isOpen && (
              ...
              >
                <button onClick={togglePlay} className="text-amber-200/70 hover:text-amber-100">
                  {isPlaying ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
                </button>
                <input
                  type="range"
                ...
                <button onClick={toggleMute} className="text-amber-200/70 hover:text-amber-100">
      ...
      <div className={`rounded-3xl border ${t.split(" ")[2]} bg-white shadow-lg overflow-hidden`}>
        ...
        <AnimatePresence>
          {isOpen && (
            ...
            >
              <div className="flex items-center gap-2">
                <button onClick={togglePlay} className="text-gray-500 hover:text-gray-800">
                  {isPlaying ? <Pause className="w-4 h-4" /> : <Play className="w-4 h-4" />}
                </button>
                <input
                  type="range"
                ...
                <button onClick={toggleFullscreen} className="text-gray-400 hover:text-gray-600">
